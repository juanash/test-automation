...
public class TestLoginPage extends PageObject {
    public static final Target LOGIN_BUTTON = Target.the("button that us the form to login").located(By.xpath("//div[@class='d-none d-lg-block]//strong[contains(text(),'Ingresar']"));
